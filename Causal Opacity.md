...
permalink: /causal-opacity.html
---

Causal Opacity is the idea that there is a barrier to understanding a system once it passes some threshold of complexity. Because of causal opacity you can neither make accurate predictions nor even really figure out how the system [got into its current state](/fractal-history.html). Some other ways of saying it would be, 
...
- Plans are unlikely to work (but planning, especially 
- [nonpredictive planning](/nonpredictive-planning.html), is still useful).
- Figuring out how history will unfold is [impossible](/fickleness-of-future.html).
- Figuring out how history unfolded is also equally [impossible](/fractal-history.html).
