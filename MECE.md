...
MECE means “mutually exclusive, collectively exhaustive”, and is a [framework](Frameworks.html) to describe a whole by listing its parts in a methodical way. That seems somewhat dry and useless, but you cannot understand something unless you can describe it, and other than MECE I have never heard of any other way to methodically start to describe things (or even talk about the philosophy of describing as a general concept (except in the *[via postiva](./Via Positiva.html)* / *[via negativa](./Via Negativa.html)* way)).
...
[There are lots of ways to be MECE](./How to be MECE.html), and the trick is to be insightful about the description. 